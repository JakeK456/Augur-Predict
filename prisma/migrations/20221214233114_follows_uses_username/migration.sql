...
-- AddForeignKey
ALTER TABLE "Follows" ADD CONSTRAINT "Follows_followerName_fkey" FOREIGN KEY ("followerName") REFERENCES "Profile"("username") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Follows" ADD CONSTRAINT "Follows_followingName_fkey" FOREIGN KEY ("followingName") REFERENCES "Profile"("username") ON DELETE RESTRICT ON UPDATE CASCADE;
